<div>
       ...
       <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
           ...
           <div class="dashboard-card bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl p-6 text-white shadow-lg">
               <div class="flex items-center justify-between mb-4">
                   ...
                   <svg class="w-6 h-6 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
               </div>
           ...
           <div class="dashboard-card bg-gradient-to-br from-secondary-500 to-secondary-600 rounded-2xl p-6 text-white shadow-lg">
               <div class="flex items-center justify-between mb-4">
                   <h3 class="text-lg font-medium">Current GPA</h3>
               ...
               <p class="text-4xl font-bold">{{ number_format($recentGrades->avg('score') / 100 * 4, 2) }}</p>
           ...
           <div class="dashboard-card bg-gradient-to-br from-accent-500 to-accent-600 rounded-2xl p-6 text-white shadow-lg">
               <div class="flex items-center justify-between mb-4">
                   ...
                   <svg class="w-6 h-6 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
               </div>
           ...
           <div class="dashboard-card bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg">
               <div class="flex items-center justify-between mb-4">
                   ...
                   <svg class="w-6 h-6 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
               </div>
               <p class="text-4xl font-bold">${{ number_format($pendingFees->sum('amount'), 0) }}</p>
               <p class="text-sm opacity-90 mt-2">{{ $pendingFees->count() }} invoices unpaid</p>
           </div>
       </div>

       <!-- Quick Links -->
       <div class="mt-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-6">
           <h3 class="text-xl font-bold font-serif-heading text-gray-900 dark:text-white mb-6">Quick Actions</h3>
           <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
               <a href="{{ route('students.print-profile', $student->id) }}" class="p-6 bg-primary-50 dark:bg-primary-900/20 rounded-xl hover:bg-primary-100 dark:hover:bg-primary-900/30 transition-all text-center group">
               ...
               <a href="#" class="p-6 bg-purple-50 dark:bg-purple-900/20 rounded-xl hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-all text-center group">
                   ...
                   <p class="font-semibold text-gray-900 dark:text-white">Pay Fees</p>
               </a>
           </div>
       </div>
   @endif
   ...
   @if($activeTab === 'timetable')
       <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-6">
           <h3 class="text-2xl font-bold font-serif-heading text-gray-900 dark:text-white mb-6">Weekly Timetable</h3>
                   ...
                   <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                       @for($hour = 8; $hour <= 15; $hour++)
                           <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                               ...
                               @foreach(['Monday','Tuesday','Wednesday','Thursday','Friday'] as $day)
                                   @php
                                       $slot = $timetableEntries->where('weekday.name', $day)->firstWhere('time_slot.hour', $hour);
                                   @endphp
                                   <td class="p-4">
                                       @if($slot)
   ...
   @if($activeTab === 'grades')
       <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
           <div class="p-6 border-b border-gray-200 dark:border-gray-700">
               <h3 class="text-2xl font-bold font-serif-heading text-gray-900 dark:text-white">Exam Results</h3>
           </div>
           <div class="overflow-x-auto">
               <table class="w-full">
                       ...
                       @forelse($recentGrades as $record)
                           <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                               ...
                               <td class="px-6 py-4 text-gray-600 dark:text-gray-400">
                                   {{ optional($record->exam->subject)->name ?? 'Multiple' }}
                               </td>
                               <td class="px-6 py-4">
       ...
       <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-6">
           ...
           @else
               <div class="text-center py-12">
                   ...
                   <p class="text-gray-500 dark:text-gray-400">No pending fees. Great job!</p>
               </div>
           @endif
       </div>
   @endif
